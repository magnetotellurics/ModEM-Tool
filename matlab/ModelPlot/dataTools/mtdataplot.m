    ...
    methods
        ...
        function [f] = plotap(obj,comp,iper,fplot)
            ...
            k = iper;
                ...
                data1 = log10(obj.apres.(comp)(:,k));
                clims1(1) = (nanmin(data1))/2;
                clims1(2) = (nanmax(data1))/2;
                range1 = clims1(2) - clims1(1);
                str1 = ['Ap. Res. ' comp];
                
                data2 = obj.phase.(comp)(:,k);
                clims2(1) = (nanmin(data2))/2;
                clims2(2) = (nanmax(data2))/2;
            ...
            if ~separateFigs && plotApres; subplot(2,1,1); end
            if plotApres
