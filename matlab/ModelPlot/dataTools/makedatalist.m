...
for i = 1:n1
    j = i;
    tflist{j} = mttf.read(fname{i},'xml','Full_Impedance');
end
...
save('USArray_impedance_list_all_20170919.mat','tflist');
...
save('USArray_impedance_list_q3+_20170919.mat','tflist3');
...
save('USArray_impedance_list_q4+_20170919.mat','tflist4');
