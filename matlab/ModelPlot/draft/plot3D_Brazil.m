...
dataFile = 'Mauricio_inv_final/Modular_NLCG_086.dat';
...
%modelFile = 'Yellowstone_10km_errfl5T3_200ohmm_smooth_NLCG_175.rho';
...
%xygrid = xygrid(Cond.grid.dx,Cond.grid.dy,Cond.grid.dz,Cond.grid.origin);

%%
clear obj
obj = Cond_xy_ll(Cond,lat0,lon0);
k = find(obj.llgrid.depth>=28, 1, 'first');
