classdef MT3DmodelCovWt < ModelCovariance
        % model covariance class for 3DMT ... just a quick and easy example
        %   MOdified from MT3DmodelCov to incerase penalty on large cells
    ...
    methods
        function obj = MT3DmodelCovWt(grid)
        ...
        %   current values of model covariance parameters
            ...
            [Dx,Dy,Dz] = ndgrid(obj.grid.dx,obj.grid.dy,obj.grid.dz);
            obj.VolWts =sqrt(Dx.*Dy);
            meanVol = mean(mean(mean(obj.VolWts(5:end-4,5:end-4,1:end-5))));
            obj.VolWts = meanVol./obj.VolWts;
        end
         %******************************************************************
